...
import { WorkloadTriageView } from "./components/WorkloadTriageView.tsx";
...
export function App() {
  ...
  const reset = () => { setAnalysis(null); setPlanSource(""); setError(""); setTab("diagnosis"); setWorkloadOpen(false); setInvestigationTitle(""); };
