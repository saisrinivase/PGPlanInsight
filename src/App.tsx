...
import { clearCases, listCases, saveCase, type StoredCase } from "./case-store.ts";
...
export function App() {
  ...
  const analyze = async (source: string, title: string) => {
