...
export function Pev2Renderer({ planSource }: { planSource: string }) {
  ...
  useEffect(() => {
    ...
    style.textContent = `${fontAwesomeDom.css()}\n${bootstrapCss}\n${pev2Css}\n
      :host { display:block; min-height:680px; color:#172a34; font-family:system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif; }
      *, *::before, *::after { box-sizing:border-box; }
      ...
      .plan-container, .plan-diagram, .diagram-container { font-family:system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif !important; }
