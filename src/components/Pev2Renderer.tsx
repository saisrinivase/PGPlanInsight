...
export function Pev2Renderer({ planSource }: { planSource: string }) {
  ...
  useEffect(() => {
    ...
    style.textContent = `${fontAwesomeDom.css()}\n${bootstrapCss}\n${pev2Css}\n
      :host { display:block; min-height:680px; color:#172a34; font-family:Verdana,Arial,sans-serif; }
      *, *::before, *::after { box-sizing:border-box; }
      ...
      .plan-container, .plan-diagram, .diagram-container { font-family:Verdana,Arial,sans-serif !important; }
      #pev2-root :where(button,a,td,th,span,p,label) { font-family:Verdana,Arial,sans-serif; }
      #pev2-root :where(pre,code), #pev2-root :where(pre,code) * { font-family:ui-monospace,SFMono-Regular,Consolas,monospace; }
