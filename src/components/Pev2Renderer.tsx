...
export function Pev2Renderer({ planSource }: { planSource: string }) {
  ...
  useEffect(() => {
    ...
    style.textContent = `${fontAwesomeDom.css()}\n${bootstrapCss}\n${pev2Css}\n
      :host { display:block; min-height:680px; color:#172a34; font-family:"IBM Plex Sans","Segoe UI",Arial,sans-serif; }
      *, *::before, *::after { box-sizing:border-box; }
      ...
      .plan-container, .plan-diagram, .diagram-container { font-family:"IBM Plex Sans","Segoe UI",Arial,sans-serif !important; }
      ...
      .plan-grid .pgplan-grid-note {
        ...
        background:#eef4f7;
        color:#526579;
        font:11px/1.4 "IBM Plex Sans","Segoe UI",Arial,sans-serif;
      }
      ...
      .pgplan-io-note {
        ...
        background:#f8fafc;
        color:#526579;
        font:12px/1.4 "IBM Plex Sans","Segoe UI",Arial,sans-serif;
      }
